-- look_flat.lua drawing engine configuration file for Notion.
...
de.defstyle("frame-transient", {
    ...
    bar = "shaped", -- Possible values: "none", "shaped", "inside", "outside".
})
...
de.defstyle("tab", {
    ...
    de.substyle("active-selected", {
        ...
        padding_colour = "#909090", -- The padding color matches the background rather
