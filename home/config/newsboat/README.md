...
Newsboat is a [fork][1] of Newsbeuter, [the Mutt of feed readers][2].  "[The only
difference is that Newsboat is actively maintained while Newsbeuter isn't.][Newsboat]"  I
set Newsboat up to mostly use the same colors I configured for Mutt as well as similar
...
*   All my YouTube subscriptions are aggregated into a single feed.  The relevant section
    ...
    See [section 4.7 of the manual][3] for the documentation of query feeds and [issue #33
    of Newsboat][4] for the reason the YouTube feeds are tagged as both `!YouTube`
    ([hidden tag][5]) and `YouTube`.
...
[3]: file:///usr/share/doc/newsboat/newsboat.html#_query_feeds
[4]: https://github.com/newsboat/newsboat/issues/33
[5]: file:///usr/share/doc/newsboat/newsboat.html#_tagging
