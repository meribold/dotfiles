...
rsync -rh --info=progress2 -e 'ssh -i '~'/.ssh/zirakzigil.pem' meribold@zirakzigil:/home/meribold/snapscore-server/received_images/ ~/snapscore-images
rsync -rh --info=progress2 SRC DEST
sco() { git checkout --detach && git reset "$1" && git checkout "$1"; }; sco
scp -i ~/.ssh/zirakzigil.pem meribold@zirakzigil:src dest
sensors
